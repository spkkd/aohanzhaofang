			...
			<view>
				<view class="wrap">
					<u-form ref="uForm">
						...
						<u-form-item label-width="150" :label-position="labelPosition" label="售价" required>
							<u-input :border="border" placeholder="请输入售价(单位:万)" v-model="model.price" type="number"></u-input>
						</u-form-item>
						<u-form-item label-width="150" :label-position="labelPosition" label="建成年份" required>
							<u-input :border="border" placeholder="请输入建成年份" v-model="model.buildYear" type="number"></u-input>
						</u-form-item>
